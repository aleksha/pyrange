...
registry = [
    ...
    ("Methane.txt", 0.000667151, ["Methane", "Метан", "CH4"]),
    ...
    ("Aluminum Oxide.txt", 3.97, ["Aluminum oxide", "Aluminium Oxide", "Оксид алюминия","Al2O3"]),
    ("Acetylene.txt", 0.0010967, ["Acetylene", "Ацетилен","C2H2"]),
    ("Carbon Dioxide.txt", 0.00184212, ["Carbon dioxide", "Диоксид углерода", "Двуокись углерода"]),
    ("Propane.txt", 0.00187939, ["Propane", "Пропан","C3H8"]),
    ("Sodium Iodide.txt", 3.667, ["Sodium iodide", "Иодид натрия", "Иодистый натрий", "NaI"]),
    ("Ethylene.txt", 0.00117497, ["Ethylene", "Этилен", "Этен", "C2H4"]),
    ("Calcium Fluoride.txt", 3.18, ["Calcium fluoride", "Фторид кальция","CaF2"]),
    ...
    ("Silicon Dioxide.txt", 2.32, ["Silicon dioxide","Silica","Диоксид кремния","SiO2"]),
    ...
    ("Lithium Fluoride.txt", 2.635, ["Lithium fluoride", "Фторид лития", "Фтористый литий", "LiF"]),
    ("Cesium Iodide.txt", 4.51, ["Cesium iodide", "Caesium iodide", "Иодид цезия", "CsI"]),
